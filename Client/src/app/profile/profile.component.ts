...
export class ProfileComponent implements OnInit {
  ...
  getDataUser() {
    this.http
      .get<any>(this.apiUrl + this.authService.getUserID(), {
        headers: {
  ...
  save(url: any) {
    ...
    this.http
      .put<any>(this.apiURLEditInfor, bodyData, {
        headers: {
          Authorization: 'Bearer ' + this.authService.getToken(),
        },
      })
  ...
  SaveEditAccount() {
    if (
      this.formEditAccount.controls.password.value !=
      this.formEditAccount.controls.confirmPassword.value
    ) {
      alert(
