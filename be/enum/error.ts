export enum ErrorMessage {
  GENERAL_PERMISSION = 'error.YOU_DO_NOT_HAVE_PERMISSION_TO_THIS_OPERATION',
  ...
  ACCOUNT_PERMISSION = 'error.YOU_DO_NOT_HAVE_PERMISSION_TO_ACCOUNT',
  ...
  DATA_DOWNLOAD_DATE_TIME = 'error.FINAL_CLOSURE_DATE_IS_STILL_AVAILABLE',
  ...
  DEPARTMENT_STILL_CONTAINS_MEMBERS = 'error.DEPARTMENT_STILL_CONTAINS_MEMBERS',
  DEPARTMENT_STILL_CONTAINS_EVENTS = 'error.DEPARTMENT_STILL_CONTAINS_EVENTS',
  DEPARTMENT_HAS_MANAGER = 'error.DEPARTMENT_IS_BEING_MANAGED_BY_QAC',
  ...
  YOU_CAN_NOT_UPDATE_ROLE_ADMIN = 'error.YOU_CAN_NOT_UPDATE_ROLE_ADMIN',
  IDEA_ATTACHMENTS = 'error.UPLOADED_FILES_MUST_BE_IN_PDF_FORMAT',
  FILE_NOT_EXISTS = 'error.FILE_DOES_NOT_EXISTS',
  IMAGE_UPLOAD_FORMAT = 'error.UPLOADED_FILES_MUST_BE_IN_JPEG_OR_PNG_FORMATS',
}
