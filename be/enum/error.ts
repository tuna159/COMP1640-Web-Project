export enum ErrorMessage {
  ...
  FIRST_CLOSURE_DATE_NEEDS_TO_BE_LESS_THAN_FINAL_CLOSURE_DATE = 'error.FIRST_CLOSURE_DATE_NEEDS_TO_BE_LESS_THAN_FINAL_CLOSURE_DATE',
  ...
  CAN_NOT_DELETE_EVENT = 'error.CAN_NOT_DELETE_EVENT',
}
